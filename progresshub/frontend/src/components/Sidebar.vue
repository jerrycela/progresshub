  ...
  <aside class="sidebar">
    ...
    <nav class="mt-2 px-3">
      ...
      <div class="space-y-1">
        ...
        <RouterLink to="/task-pool" class="sidebar-link" :class="{ active: isActive('/task-pool') || route.path.startsWith('/task-pool') }">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <RouterLink to="/roles" class="sidebar-link" :class="{ active: isActive('/roles') }">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
