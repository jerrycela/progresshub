...
const functionLabel = computed(() => functionTypeLabels[user.value.functionType] || user.value.functionType)
const departmentLabel = computed(() => departmentLabels[user.value.department] || user.value.department)
